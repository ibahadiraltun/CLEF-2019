...
def save_y_train_vector(vec):
    fpath = '/Users/ibahadiraltun/Desktop/CLEF-2019-CheckThat/CLEF2019_Task1/data/submissions/solution_primary/vectors/y_train.txt'
    np.savetxt(fpath, vec, fmt = '%f')

def save_X_train_vector(vec):
    fpath = '/Users/ibahadiraltun/Desktop/CLEF-2019-CheckThat/CLEF2019_Task1/data/submissions/solution_primary/vectors/X_train.txt'
    np.savetxt(fpath, vec, fmt = '%f')

def save_X_test_vector(fname, vec):
    fpath = '/Users/ibahadiraltun/Desktop/CLEF-2019-CheckThat/CLEF2019_Task1/data/submissions/solution_primary/vectors/X_test/' + fname
    np.savetxt(fpath, vec, fmt = '%f')
